...
public_url
# Crear túnel para puerto 8501 (Streamlit)
public_url = ngrok.connect(8501)

print("🚀 Tu app está disponible en:")
print(public_url)
...
# 
# st.set_page_config(page_title="InvestiData - Analítica de Extracciones Forenses", layout="wide")
# 
# # --- HEADER ---
# st.title("📊 InvestiData – Analítica de Extracciones Forenses")
# st.write("Mapas, Nombres propios, Detección de patrones y Grafo de contactos. Usa el uploader o el archivo ya cargado.")
# 
# # --- MODO OSCURO ---
...
# uploaded_file = st.file_uploader("📂 Cargar archivo XLSX (opcional)", type=["xlsx"])
# use_default = st.checkbox("Usar archivo integrado de la sesión (si no subo archivo)", value=True)
# # ============================================================
...
#             💬 <b>+57 311 252 8641</b> – “Calvin Klein”<br>
#             🔢 <b>IMEI:</b><br>
#             &nbsp;&nbsp;• 354102943867594<br>
#             &nbsp;&nbsp;• 354102943902490<br>
#             🎨 <b>Color:</b> Gris<br>
...
# 
#     with col_left:
#         st.success("✔ Archivo cargado correctamente. Continúa con el análisis…")
# 
...
#     # pandas aceptará el file-like object
#     try:
...
# 
# # --- MÓDULO: DETECCIÓN DE NOMBRES PROPIOS (heurística) ---
# st.markdown("---")
# st.subheader("🧾 Nombres propios detectados (heurística)")
...
# # Extrae tokens que comienzan con mayúscula y al menos 2 letras, evitando inicio de frases comunes
...
# 
# # --- MÓDULO: DETECCIÓN DE PATRONES Y SUSPICIOSOS ---
# st.markdown("---")
# st.subheader("🚨 Detección de patrones sospechosos")
# # keywords de delitos
# keywords = ["arma","pistola","revólver","droga","matar","niña","extorsión","vacuna","pagar","amenaza"]
...
# 
# # detectar números (teléfonos) y ver repetidos
...
# 
# # --- MÓDULO: MAPA (si hay coordenadas) ---
# st.markdown("---")
# st.subheader("🗺️ Mapa de ubicaciones (si existen columnas de lat/lon)")
...
#         st.map(map_df)
#     except:
#         st.info("Las columnas de coordenadas existen pero no están en formato numérico.")
# else:
#     st.info("No se detectaron columnas de latitud/longitud en la hoja (busque columnas que contengan 'lat' y 'lon').")
# 
# # --- MÓDULO: GRAFO DE CONTACTOS (si hay remitente y receptor) ---
# st.markdown("---")
# st.subheader("🔗 Grafo de contactos (remitente -> receptor)")
# 
...
# 
# # --- SECCIÓN: INFORMACIÓN DEL PROPIETARIO (si existe alguna hoja con 'propiet' o 'device') ---
# st.markdown("---")
# st.subheader("👤 Información probable del propietario del dispositivo")
# owner_sheets = [s for s in xls.sheet_names if any(k in s.lower() for k in ["propiet", "device", "inform", "owner"])]
# if owner_sheets:
#     st.write("Hoja(s) detectada(s) con posible información del propietario:")
...
# else:
#     st.info("No se encontró una hoja que claramente identifique al propietario (busca nombres como 'Propietario', 'Device Info', 'Información').")
# 
