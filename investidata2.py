...
FINAL_HTML = HTML_TEMPLATE.format(
    ...
    TRANSITION_SHORT=TRANSITION_TIME_SHORT,  # Coincide con {TRANSITION_SHORT}
    TRANSITION_MEDIUM=TRANSITION_TIME_MEDIUM, # Coincide con {TRANSITION_MEDIUM}
    FONT_SIZE=FONT_SIZE_TOOLTIP,            # Coincide con {FONT_SIZE}
    TOOLTIP_OPACITY=TOOLTIP_OPACITY_VAL     # Coincide con {TOOLTIP_OPACITY}
)
